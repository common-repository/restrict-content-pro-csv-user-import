...
**On October 14th, 2021, Restrict Content Pro CSV User Import will be removed from the WordPress plugin repository.**

**The plugin is unnecessary now that the User Import functionality has been added to the core Restrict Content Pro plugin.** 
...
== Changelog ==
= 1.1.12 =
* New: Notice regarding plugin changes
